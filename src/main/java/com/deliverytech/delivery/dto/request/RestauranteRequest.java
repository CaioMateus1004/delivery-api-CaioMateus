...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Representa o request para criação de um restaurante")
public class RestauranteRequest {

    @NotBlank
    @Schema(description = "Nome do restaurante", 
    example = "restaurante do zé e cia")
    private String nome;
    ...
    example = "(99)6666-6666")
    private String telefone;

    @Positive
    @Schema(description = "Taxa de entrega em Reais (R$)", 
    example = "5.00")
